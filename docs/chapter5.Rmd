...
The main advantage for identifying graphical elements to data is that we have more flexibility in targeting sub components of a plot. A prime example of an interaction that is difficult to implement across other tools is linking a part of the box plot to other plots (seen in Figure 4.2.1).
...
```{r, echo = FALSE, fig.cap = "Figure 5.2: control density bandwidth with interactr"}
...
```
```{r, echo = FALSE, fig.cap = "Figure 5.3: control density bandwidth with ggvis"}
...
```{r, echo = FALSE, out.width = "500px", fig.cap = "Figure 5.4: control density bandwidth with shiny"}
...
```{r, echo = FALSE, fig.cap = "Figure 5.5: control density bandwidth using plotly (rendered with ggplot2) and shiny"}
