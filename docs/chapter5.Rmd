...
- assumes no missing values and that plots generated via gridSVG should be in the order of the data frame. (ie point order should match with indices of the data frame.) In cases where data taken in is rearranged and sorted (like iNZightPlots), this causes the 'indexes' of the points to differ to the original dataframe.
