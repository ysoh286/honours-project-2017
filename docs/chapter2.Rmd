...
*Figure 2.7: from RStudio, explaining how inputs and outputs work*
...
*Figure 2.8: A simplistic shiny application that has a slider to control the smoothness of the trendline*
...
*Figure 2.9: Facetted ggplot with linked brushing and hovers*
...
*Figure 2.10: A lattice plot that fails to produce correct mapping*
...
*Figure 2.12: an example of linked brushing between ggvis plots*
