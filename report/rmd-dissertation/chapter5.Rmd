...
- This setup cost also comes with a speed cost as well - as every request made must be communicated back and forth between R and the browser, thus slower standalone solutions that operate on JavaScript
