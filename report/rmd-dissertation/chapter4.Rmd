...
```{r, fig.cap = "\\label{fig:bp} Producing a box plot in R", comment = NA}
listElements(bw)
...
```{r, echo = FALSE, fig.cap = "\\label{fig:int-slider-1} Plot with slider"}
...
```{r, echo = FALSE, fig.cap = "\\label{fig:int-slider-2} Plot with slider that controls the smoothness of the trend line"}
...
```{r, echo = FALSE, fig.cap = "\\label{fig:int-slider-3} Plot that has a selection box feature that draws a separate smoother"}
